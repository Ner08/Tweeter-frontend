...
<template>
    <div class="d-flex align-items-start">
        <ProfileIcon />
        <div class="container">
            <textarea @click="toggleSelect" data-autoresize class="d-inline m-2 form-control-lg w-95 rounded-0" rows="1"
                type="text" placeholder="What is happening?!" id="exampleFormControlTextarea1"></textarea>
            <p v-if="selected" class="text-primary fw-bold mx-3 p-2 mb-2" :class="selected ? 'selected' : ''"><i
            ...
            <div class="d-flex justify-content-end px-3 pb-3">
                ...
                <IconForm :class="iconPoll" />
                <IconForm :class="iconEmoji" />
